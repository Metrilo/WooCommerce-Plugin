<?php
    if(class_exists('WooCommerce')){
        ...
        if(is_product()){
            ...
            $this->put_event_in_queue(
                "window.metrilo.viewProduct('$product_id');"
            );
        }
        ...
        if (is_product_category()) {
            ...
            $this->put_event_in_queue(
                "window.metrilo.viewCategory('$category_id');"
        ...
        if (is_search()) {
            ...
            $this->put_event_in_queue(
                "window.metrilo.search('$search_query', '$search_link');"
            );
        }
        ...
        if (is_order_received_page()) {
            ...
            $this->put_event_in_queue(
                "window.metrilo.viewPage('$url', $name);"
            );
    ...
    if (is_single() && !is_product()) {
        ...
        $this->put_event_in_queue(
            "window.metrilo.viewArticle('$post_id', $name_and_url);"
        );
    }
