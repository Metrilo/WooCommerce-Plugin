...
= 1.7.22 =
* Fixed: New plugin version fixing the cookie data encoding

= 1.7.21 =
* New: Added additional configuration to exclude page view event

= 1.7.20 =
* Fixed: Customer identify api call sending escaped unicode characters for cyrillic language

= 1.7.19 =
* Fixed: Removed deprecated get_magic_quotes_gpc method for php version 7.4+
